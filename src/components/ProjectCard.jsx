    ...
    >
        <div
            className={`rounded-2xl overflow-hidden border transition-all duration-500 ${
                isDarkMode 
                    ? "bg-gray-900/50 border-gray-800 hove:border-gray-700 hover:shadow-2xl hover:shadow-blue-500/10"
                    : "bg-white/80 border-gray-200 hover:border-gray-300 hover:shadow-2xl hover:shadow-blue-10"
            } backdrop-blur-sm`}
        >
            {/* Project Image */}
            ...
            {/* Project Content */}
            <div className="p-6">
                <h3 className="text-xl font-medium mb-3 group-houver:text-blue-500 transition-colors">
                    {project.title}
                </h3>
