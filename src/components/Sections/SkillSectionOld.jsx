                        ...
                        {category.skills.map((skill, skillIndex) => (
                            <div key={skill.name} className="group">
                                ...
                                >
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-white/20 rounded-full opacity-0 group-houver:opacity-100 transition-opacity duration-300" />
                                    </motion.div>
                                </div>
                            </div>
                        ))}
            ...
            {/* Additional Skill */}
                ...
                >
                    <motion.div variants={itemVariants} className="text-center mb-8">
                        <h3 className="text-xl font-medium mb-4">Também trabalho com</h3>
                    </motion.div>
