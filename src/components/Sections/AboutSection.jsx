        ...
        >
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    ...
                    >
                        Sobre
                        <span className="text-blue-500 font-medium"> Mim</span>
                    </motion.h2>
                </motion.div>
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-start">
                    ...
                    >
                        ...
                        >
                            <h3 className="text-2xl font-medium mb-6">Minha missão</h3>
                            <p
                        ...
                        <motion.div variants={itemVariants} className="space-y-4">
                            <h3 className="text-xl font-medium mb-6">O Que Eu Gosto de Construir</h3>
                        ...
                        <motion.div variants={itemVariants} className="text-center py-8">
                            ...
                            >
                                construido com atenção por
                            </div>

                            <div className="flex justify-center">
                                <img src={SIGNATURE} alt="Richard" className="w-28" />
                            </div>
